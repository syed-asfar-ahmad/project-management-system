  ...
  return (
    ...
    <section className="py-12 px-6 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 animate-fade-in-up">Key Features</h2>
            ...
            {/* Feature Card 1 */}
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 animate-fade-in-up delay-300">
                <div className="w-14 h-14 bg-blue-100 text-blue-600 flex items-center justify-center rounded-full mb-4">
                <ClipboardList className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-semibold mb-2">Task Management</h3>
                <p className="text-gray-600">Easily create, assign, and track tasks with deadlines and priorities.</p>
            </div>

            {/* Feature Card 2 */}
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 animate-fade-in-up delay-400">
                ...
                <p className="text-gray-600">Visualize project progress with timelines, stats, and overviews.</p>
            </div>

            {/* Feature Card 3 */}
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 animate-fade-in-up delay-500">
                <div className="w-14 h-14 bg-green-100 text-green-600 flex items-center justify-center rounded-full mb-4">
                <MessageCircle className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-semibold mb-2">Team Collaboration</h3>
                <p className="text-gray-600">Comment, tag teammates, and work together in real time.</p>
            </div>

            {/* Feature Card 4 */}
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 animate-fade-in-up delay-600">
                ...
                <p className="text-gray-600">Give admins, managers, and members the right permissions.</p>
            </div>

            {/* Feature Card 5 */}
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 animate-fade-in-up delay-700">
                <div className="w-14 h-14 bg-pink-100 text-pink-600 flex items-center justify-center rounded-full mb-4">
            ...
            {/* Feature Card 6 */}
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 animate-fade-in-up delay-800">
                <div className="w-14 h-14 bg-red-100 text-red-600 flex items-center justify-center rounded-full mb-4">
                <CheckCircle className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-semibold mb-2">Progress Tracking</h3>
                <p className="text-gray-600">Monitor milestones and task completion across all projects.</p>
            </div>
            </div>
        </div>
    </section>
